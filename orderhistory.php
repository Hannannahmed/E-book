...
<body>
	<div class="page-wraper">
      ...
      <h4 class="widget-title text-center">Order History</h4>
				<!-- Product -->
				<?php
...
$totalPrice = isset($_SESSION['totalPrice']) ? $_SESSION['totalPrice'] : 0;
    ...
    $userquery = "select * from orders where user_id=$uid";

    $dly = mysqli_query($connect, $userquery);
 while( $fetch  = mysqli_fetch_assoc($dly)) {
...
<div class="container">
                  ...
                  <tr>
											...
											<td class="product-price"><?php echo $fetch ['placed_on'] ?></td>
										</tr>
										<tr>
...
<td>
    <!-- <a href="competition/pdf/Untitled document.pdf" download>
        <button id="btn">Download Your PDF</button> -->
        <a class="btn btn-danger" href="deleteorder.php?cencelorder=<?php echo $fetch ['id'] ?>">Cancel Order</a>
