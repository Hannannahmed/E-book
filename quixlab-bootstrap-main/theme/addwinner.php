                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="addwinnersaction.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Prize <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-prize" placeholder="Enter a Prize..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Awarde date <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="date" class="form-control" id="val-email" name="val-date" placeholder="Your valid email..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Awarde date <span class="text-danger">*</span>
                                            ...
                                            <div class="col-lg-6">
                                            <select class="form-control" id="val-category" name="val-winners">
...
require '../../connection.php';
            ...
            <?php }?>
                                       ...
                                       <button type="submit" name="winner"> Add Winner</button>
                                    </form>
                                </div>
                            </div>
                        </div>
