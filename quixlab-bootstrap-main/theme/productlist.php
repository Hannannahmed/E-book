...
$query = "SELECT products.id, products.name, products.image, products.author, products.price, products.category, category.category_name
          FROM products
...
while($row =mysqli_fetch_assoc($db)){
						...
						<div class="dz-shop-card style-1">
							...
							<div class="dz-media">
								<img src="<?php echo $row ["image"]  ?>" alt="book" height="220px" width="100%">
							</div>
                            <br>
							...
							<div class="dz-content">
								...
								<ul class="dz-tags">
                                    <center>
									<li><h5>Book Name:<?php echo $row ["name"]  ?></h5></li>
									<li><h5>Author Name:<?php echo $row ["author"]  ?></h5></li>
									<li><h5>Category:<?php echo $row ["category"]  ?></h5></li>
									<li><h5>Price:<?php echo $row ["price"]  ?></h5></li>
                                    </center>
                                </ul>

								<div class="book-footer">
                                <center>
									<a href="update.php?updateid=<?php echo $row ["id"]  ?>"><button class="btn btn-primary">Update</button></a>
                                    <a href="productdeleteaction.php?deleteid=<?php echo $row ["id"]  ?>"><button class="btn btn-danger">Delete</button></a>
                                    </center>
								</div>
							</div>
