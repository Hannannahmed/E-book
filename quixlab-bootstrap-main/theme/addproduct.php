                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="addproductaction.php" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-productname" placeholder="Enter a Productname..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="val-username" name="val-authorname" placeholder="Enter a Productname..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-email" name="val-price" placeholder="Enter price">
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
require '../../connection.php';
            ...
            <?php }?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                            <input type="file" class="form-control" id="val-image" name="val-image-1" placeholder="..and confirm it!">
