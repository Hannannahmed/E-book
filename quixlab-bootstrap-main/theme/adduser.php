                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="adduseraction.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">user Image <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="file" class="form-control" id="val-confirm-password" name="val-image" placeholder="..and confirm it!">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">Role <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">


                                            <select class="form-control" id="val-confirm-password" name="val-role">
