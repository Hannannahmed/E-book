...
$upadteid =$_GET["updateid"];


$query ="select * from products where id=$upadteid ";
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="update_product.php?finalupdate=<?php echo $upadteid?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Product Name <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" value="<?php echo $row ['name'] ?>" id="val-username" name="val-productname" placeholder="Enter a Productname..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Author Name<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control"  value="<?php echo $row ['author'] ?>" id="val-username" name="val-authorname" placeholder="Enter a Productname..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">Price <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" value="<?php echo $row ['price'] ?>" class="form-control" id="val-email" name="val-price" placeholder="Enter price">
                                            </div>
                                        </div>
                                        <div class="form-group row">
    <label class="col-lg-4 col-form-label" for="val-category">Category <span class="text-danger">*</span></label>
    <div class="col-lg-6">
...
require '../../connection.php';
            ...
            <?php }?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-confirm-password">Image 1 <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                            <input type="file" value="<?php echo $row ['image'] ?>" class="form-control" id="val-image" name="val-image-1" placeholder="..and confirm it!">
