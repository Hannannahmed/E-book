             ...
             $row =mysqli_fetch_assoc($db);
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative"   data-toggle="dropdown">
                                ...
                                <img src="../../<?php  echo $row ['image']?>" height="40" width="40" alt="">
                            </div>
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        <li>
                                            <a href="app-profile.php"><i class="icon-user"></i> <span><?php  echo $row ['name']  ?></span></a>
                                        </li>
                                        <li>
                                            <a href="javascript:void()">
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <?php
                                    require '../../connection.php';
                                    $totalbooks="select count(id) as totalBooks from products";
                                    $dlvryboy=mysqli_query( $connect,$totalbooks);
                                    $row=mysqli_fetch_assoc($dlvryboy);

                                    ?>
                                    <h2 class="text-white"><?php echo $row["totalBooks"];?></h2>
...
require '../../connection.php';
                                    $totalbooks="select count(id) as totalusers from users";
                                    $dlvryboy=mysqli_query( $connect,$totalbooks);
                                    $row=mysqli_fetch_assoc($dlvryboy);
?>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $row ['totalusers'] ?></h2>
...
require '../../connection.php';
                                    $totalbooks="select count(id) as totalorders from orders";
                                    $dlvryboy=mysqli_query( $connect,$totalbooks);
                                    $row=mysqli_fetch_assoc($dlvryboy);
?>
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $row ['totalorders']  ?></h2>
...
require '../../connection.php';
                                    $totalbooks="select count(category_id) as totalcategory from category";
                                    $dlvryboy=mysqli_query( $connect,$totalbooks);
                                    $row=mysqli_fetch_assoc($dlvryboy);
?>
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php echo $row ['totalcategory'] ?></h2>
