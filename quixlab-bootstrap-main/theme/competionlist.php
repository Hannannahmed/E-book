...
while ($row =mysqli_fetch_assoc($dboy)){
  ...
  $pdfFileName= $row["pdf"];
  $pdfPath = "../../competition/" . $pdfFileName;
                                    ...
                                    <tbody>
                                        <tr>
                                           <td> <?php echo $row  ["id"] ?></td>
                                            ...
                                            <td><?php echo $pdfFileName ?></td>


                                            <td>
                                          <!-- <a href="<?php echo $pdfPath; ?>" download>
                <button class="btn btn-primary">Download PDF</button></a> -->
                                          <a href="<?php echo $pdfPath; ?>" class="btn btn-primary btn-sm" target="_blank" download>Download PDF</a>
                                          </td>
                                          <td>
                                            <a href="deletecompetitionaction.php?compettionid=<?php echo $row  ["id"] ?>">  <button class="btn btn-danger" >Delete Competetor</button></a>
                                            </td>
                                        </tr>
